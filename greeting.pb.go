...
package grpc //import "github.com/HOJIN-HAN/pb"
...
var file_greeting_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x25, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69,
	...
	0x0d, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18,
	0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x44, 0x0a, 0x08, 0x47, 0x72, 0x65, 0x65,
	0x74, 0x69, 0x6e, 0x67, 0x12, 0x38, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x47, 0x72, 0x65, 0x65, 0x74,
	0x12, 0x15, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x62, 0x06,
...
var file_greeting_proto_goTypes = []interface{}{
	(*GreetingRequest)(nil), // 0: grpc.GreetingRequest
	(*GreetingReply)(nil),   // 1: grpc.GreetingReply
}
var file_greeting_proto_depIdxs = []int32{
	0, // 0: grpc.Greeting.SayGreet:input_type -> grpc.GreetingRequest
	1, // 1: grpc.Greeting.SayGreet:output_type -> grpc.GreetingReply
...
func (c *greetingClient) SayGreet(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingReply, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.Greeting/SayGreet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeting_SayGreet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Greeting/SayGreet",
	}
